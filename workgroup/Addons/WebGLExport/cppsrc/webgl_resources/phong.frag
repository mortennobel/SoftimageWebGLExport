...
void main(void) {
	vec3 textureColor = texture2D(diffuseTexture, texCoord).xyz;
	...
	vec3 ambientTerm = lightAmbient * ambient * textureColor;
	vec3 diffuseTerm = lightDiffuse * diffuseContribution * textureColor * diffuseColor;
